...
res =
  ...
  ,"s898\tPhrUtt NoPConj (UttS (UseCl (TTAnt TPres ASimul) PPos (PredVP (DetCN this8denna_Quant (UseN cat_N)) (ComplSlash (SlashV2a hunt_V2) (MassNP (UseN car_N)))))) NoVoc"
   ...
   -- redan tänker antalet katter
   ,"s1321\tPhrUtt NoPConj (UttS (AdvS already_Adv (UseCl (TTAnt TPres ASimul) PPos (PredVP (DetCN (DetQuant DefArt NumSg) (ComplN2 numberOf_N2 (DetCN (DetQuant IndefArt NumPl) (UseN cat_N)))) (UseV think_V))))) NoVoc"
   ...
   ,"s1617\t? (? (MassNP (UseN cat_N))) (PrepNP for_Prep (MassNP (AdjCN (PositA gallande_A) (UseN car_N))))" 
