...
person exist \cite[\textsection 310 \& 319]{H&H}, distinct from the normal 3rd
person forms.
%\enumsentence{
%\begin{tabular}{llll}
...
passives, (\ref{ex:passV32}a) and (\ref{ex:passV32}b), both covered by our grammar.
\eenumsentence{
...
\\\shortex{6}
{Hon & erbjöds & jobbet &\hspace{18pt}Jobbet & erbjöds & henne }
{\emph{she} &\emph{ offered+\textbf{s}}&\emph{ the job}
&  \hspace{18pt}\emph{the job} & \emph{offered+\textbf{s}}&\emph{ her}}
