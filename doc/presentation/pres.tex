...
\begin{itemize}
\item\textbf{One concrete syntax for each grammar}\\
\item\textbf{Linearization rules}\\
{\verb-ComplSlash vp obj = vp ++ obj }\\
{\verb-PredVP np vp = np ++ vp }\\
 \end{itemize}
 \end{frame}
...
\begin{itemize}
\item {\verb OOO } (other object)
\item {\verb SSS } (subjective predicative complement)
\item {\verb IIO} (indirect object)
\item {\verb OOA (PP ..)} (other adverbial with a prepositional phrase)
\end{itemize}
\end{frame}
