...
\begin{figure}[h]
\begin{verbatim} 
> parse "jag ser dig" | visualize_parse
> parse "jag ser dig" | visualize_tree
\end{verbatim}
...
%a visualization of a abstract syntax tree and a parse tree.
\begin{figure}[h]
>> example, typ : i see you. 
\caption{Visualized GF trees}
\label{fig:gftree1}
\end{figure}
...
%>> fotnoote that they are not complete
...
>> reformulate so that I don't sound stupid
...
grammar and the to which the result has a strong connection.
