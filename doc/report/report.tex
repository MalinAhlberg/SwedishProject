...
{It & misses & coffee}
{''There is no coffee"}}
A special GF category was needed for this, the \verb|SimpleVP|.

There are also restrictions on the nounphrase of the subject, it can only
be determined in certain ways
\enumsentence{\begin{tabular}{ll}
*Det sitter den fågel på taket. & **Det sitter fåglarna på taket.\\
There are that bird sitting on the roof & There are the birds sitting on the roof \\
\end{tabular}}
The distinction lays in the definitness of the noun: 
it must be indefinite, even though some determiners are allowed.
