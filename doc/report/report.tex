...
\abstract{
The thesis describes the work formalising an important fragment of Swedish
in the GF formalism and to compare and evaluate the possibilities of using GF
for modelling large-scale grammars. Grammatical constructions specific to and
...
{I & let & be &\textbf{to} &watch}
{I don't watch}
\item \shortexnt{4}
{*Jag & låter & bli & titta} 
{I & leave &be & watch}}\label{sent:complVV2}
%ComplBareVV, SupCl
