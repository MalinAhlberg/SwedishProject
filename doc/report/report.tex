...
>>Connection between grammar and parser: GF, every grammar defines a parser.
>> reusablilty, freely available.
>> the big amount of data, need language technology, machine translation
>> parsing: assingn of morph. and syntactic structures.
>>Connection between grammar and parser: GF, every grammar defines a parser.
...
designed for multilingual applications and is equivalent to Parallel Multiple
Context-Free Grammars (Seki \& al. 1991), it is hence stronger than mildly
...
types, for using ontologies\cite{ramona}(>>check!!) or generating natural
...
although this happened seldom. % frysa,fisa passive preterium 
