...
\abstract{
This thesis describes the work to achieve a covering Swedish grammar implemented
...
\\The thesis explains the methods and technologies used and further inspects the possibilities
...
describing grammar and syntax, in this case reflexive pronouns.
...
%(~~devoted~~) 
supervisor Ramona Enache for all her help and guidence 
%(encouragement)
...
for all his support, advice and patience and  -- most importantly -- for being such a good friend. %for having listened to 
...
4/5 of the word forms are compounds and when performing the inteded parsing,
...
noun phrase \cite{gazdar}. When we combine the \verb-SlashVP- with the object we
...
\label{sent:tittapa}}
\begin{figure}[h]
\subfloat[Verb with a chosen preposition]{\label{pic:tittapa}\includegraphics[height=90mm]{tittapa.jpg}}
\hspace{10mm}
...
and topicalized clauses, as in figure \ref{fig:clause2}.\\
...
Furthermore, the antencedent must be within the same finite sentence as the reflexive
...
\enumsentence{\begin{tabular}{llll}
...
Swedish and Norwegian use two auxilirary verbs for future tense
\cite[p. 246]{H&H}:
...
The focusing adverbs are usually not combined with modal verbs, the copula or temporal auxiliries. 
...
which groups an inifinitival verb and its object together into a \verb|VP|.
...
%Our results are lower than the results of the mapping of Penn Treebank.
