...
While the POS-tags are reserved for words, the categories give grammatictal information,
...
As these functions serve to provide stylistic flexiblity when parsing, they can be left out
