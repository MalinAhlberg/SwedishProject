...
\abstract{
This thesis describes the work to develop a wide-coverage grammar for
...
combine existing language technology resources with
new techniques and our motivation is the goal of achieving a parser
for unrestricted Swedish.
To reach this goal, problems of computational as well as linguistic nature had
to be solved.  The work includes the development of the grammar,
%in the GF formalism
to identify and formalize 
grammatical constructions %specific to and
frequent in Swedish, as well as methods for importing a large-scale lexicon and to evaluate
...
combining our rule-based grammar with statistical means.
We compare and discuss the advantages and problems of using GF
...
We also need be algorithms for
