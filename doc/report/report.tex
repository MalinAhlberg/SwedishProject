...
The grammar formalism GF has so far been successful used for 
controlled languages, but recent experiments have showed
...
also a great theoretical and technical challenge. In order to not reinvent the wheel
...
Swedish verbs may take up to five arguments \cite[p. xx]{stymne}.
...
We have a clause in which the subject must agree with the added pronoun in natural gender and
in 
%
...
\subsubsection{Solving overgeneration}
...
\subsubsection{Using Talbanken to assign correct categorise\\
