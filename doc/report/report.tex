...
work pretty well by letting all subject depend on the subject in the phrase.
Extra info, but true 'han såg sin mammas bil', they same could be applied to
APs for 'han är längre än sin kompis' or Adv for 'han leker oftare än sin kompis'. (ComparAdvAdj)
The current version is nice and works for recursive genitivs, but atm you can't focus
this kind of object, then a ClSlash need info about the subject. FunRP also tricky, in this
case RP needs to give more information.
...
sTop ambiguities by fixing so that Gen of a quant isn't a quant.
