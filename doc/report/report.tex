...
Words with multiple meanings are separated inte different entries.
...
information. Valencies are however crucial for GF, and it remains as future work to
use the results from the mapping (see section \ref{sec:Mapping})
to extract information about how words are normally used and how to automatically build
...
Regression testing was used to ensure that no blabla was lost during the development. % in order to  very easy to destroy what was working before. 
