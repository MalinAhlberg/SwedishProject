...
\label{sent:tittapa}}
\begin{figure}[h]
\subfloat[Verb with a chosen preposition]{\label{pic:tittapa}\includegraphics[height=80mm]{tittapa.jpg}}
\hspace{10mm}
\subfloat[Verb with particle]{\label{pic:tittapart}\includegraphics[height=80mm]{tittapart.pdf}}
...
\subfloat[GF abstract tree]{\label{pic:gftree}\includegraphics[width=90mm]{gfTree.pdf}}
...
random generation. However, an abstract tree has a meaningful interpretation,
the linearization should be correct. There are some cases when the correctness
of the output has been ignored in order to increase the expressivity, such
as ComplBareVV, SupCl. These functions should be excluded or enhanced when doing
careful generation...
``övriga datorer idag som ska vara inte skulle ha målats rödare än johan"
