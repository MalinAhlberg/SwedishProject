...
conj_forms :: [VerbForm]
conj_forms = [VF (PresKonj v) | v <- values] ++
             [VF (PretKonj v) | v <- values]
...
instance Param NumOrd where
    ...
    prValue Numeral     = unwords ["num", prValue Fem]
