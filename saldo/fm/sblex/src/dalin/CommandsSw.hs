...
sal_tail =
 ...
 paradigm_h "pn_o_ingendera"        ["ingendera"] $
  ...
  paradigm_h "nn_vn_medium" ["medium"]  $     
   noun_f 0 Neutr  ([e ""], [(tk 2,"et")], [(tk 2,"er"),(tk 2,"a")], [(tk 2,"erna"),(tk 2,"ana")]),
  ...
  paradigm_h "nn_vu_ponny" ["ponny"]  $      
   noun_f 0 Utr ([e ""], [e "n"], [(tk 1,"ies"),(id,"er")], [e "erna",(tk 1,"iesarna")]),
  ...
  paradigm_h "nn_vu_igloo" ["igloo"]  $
   noun Utr [""] ["n"] ["r","er","s"] ["rna","erna","sarna"],
  ...
  paradigm_h "nn_5n_altare" ["altare"]  $
   noun_f 0 Neutr ([e ""], [e "t"], [e "n"], [(tk 1,"na")]),
  ...
  paradigm_h "nn_vu_order" ["order"]  $
   noun_f 0 Utr ([e ""], [e "n"],[(id,""),(dv,"ar")],[e "na", (dv,"arna")]), 
...
sal =
 [
  ...
  paradigm_h "nn_1u_skyltdocka" ["skyltdocka"] $
   noun_compound 1 Utr ([e "a"], [e "an"], [e "or"], [e "orna"],[e "e",(ds,"")],[e "e",(ds,"")]),
 ...
 noun_compound 0 Utr ([e ""],[e "n", e "en"], [], [],[e ""],[e ""]),  
  ...
  paradigm_h "nn_3u_kavaljer"     ["kavaljer"]  $
   noun_f 0 Utr ([e ""], [e "en", e "n"], [e "er"], [e "erna"]),  
  ...
  paradigm_h "nn_vv_demo" ["demo"] $
   noun_compound 0 Pend 
    ([e ""], [e "n", e "t"], [e "n",e "s",e "sar",e "r"], [e "na",e "sen",e "sarna",e "rna"],[e ""],[e ""]),
  paradigm_h "nn_2u_botten" ["botten"] $
   noun_compound 0 Utr  ([e ""], [(dvu,"en"),e ""], [(dvu, "ar")], [(dvu,"arna")],[e ""],[e ""]),   
  paradigm_h "nn_2u_nyckel" ["nyckel"] $
    noun_compound 0 Utr ([e ""], [e "n"], [(dvu,"ar"),(dv, "ar")], [(dvu,"arna"),(dv,"arna")],[e ""],[e "",(ds,"")]),   
...
vbm_paradigm p xs = case catMaybes [Map.lookup v_id verb_map | v_id <- vids] of
 ...
 where verb_map = Map.fromList [(s,f) | (s,_,f) <- verb_paradigms]
       clean = (if is_reflexive p then remove_param "s-form" else id) . remove_param "sms" . remove_param "c" . remove_param "pret_part"
...
verb_paradigms = [
  ...
  paradigm_h "vb_2m_mysa" ["mysa"] $ 
   verb_weak_sform_variant 1 ([e "a"], [e "er"], [e ""], [e "te"], [e "t"], []),
  ...
  paradigm_h "vb_2a_ansöka"                   ["ansöka"] $
    verb_weak_sform_variant 1 ([e "a"], [e "er"], [e ""], [e "te"], [e "t"], [e "t"]),
  ...
  (verb_full 0 ([e ""], [e "nge"],[e "r"],[e ""], [(vc "i","ck")], [(vc "i","nge")], [e "tt"], [])),
