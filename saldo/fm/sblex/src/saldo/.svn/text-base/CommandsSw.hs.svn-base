...
-- nocmp f = \s ->  remove_param "ci" $ remove_param "cm" $ f s
...
sal_tail =
 [
  paradigm_h "pm_neh_harmagedon" ["Harmagedon"]  $ pm_n "ls",            
...
--   noun_compound 0 Utr ([e ""], [e "en", e "n"],[],[],[e ""],[e ""]),
 ...
 paradigm_h "nnm_3u1_film" ["dans på rosor"]  $
  ...
  paradigm_h "avm_0x0_bred" ["naggande god"]  $ 
     nocmp $ last_mw "avm" (adj 0 ([e ""], [(tk 1,"tt")], [e "e"], [e "e"], [], [], [])),
  paradigm_h "avm_0x0_gul" ["Gudi behaglig"]  $ 
     nocmp $ last_mw "avm" (adj 0 ([e ""], [e "t"], [e "e"], [e "e"], [], [], [])),
  paradigm_h "avm_0x0_korkad" ["fly förbannad"]  $ 
     nocmp $ last_mw "avm" (adj 0 ([e ""], [(tk 1, "t")], [e "e"], [e "e"], [], [], [])),
  paradigm_h "avm_0x0_utbrunnen" ["inte oäven"]  $ 
     nocmp $ last_mw "avm" (adj 0 ([e ""], [(tk 1, "t")], [(tk 1,"e")], [(tk 1, "e")], [], [], [])),

  paradigm_h "avm_0p1_gul" ["hal som en ål"]  $ 
     nocmp $ first_mw "avm" (adj_no_genitive_c 0 ([e ""], [e "t"], [], [], [], [], [],[])),
  ...
  paradigm_h "avm_0p1_brydd" ["stadd i"]  $ 
     nocmp $ first_mw "avm" (adj_no_genitive_c 0 ([e ""], [(tk 2,"tt")], [], [], [], [], [],[])),
  paradigm_h "avm_0p0_diverse" ["ute efter"]  $ 
     nocmp $ last_mw "avm" av_i_diverse,
  paradigm_h "avm_1p1_bred" ["glad i"]  $ 
     nocmp $ first_mw "avm" (adj_no_genitive_c 0 ([e ""], [(tk 1,"tt")], [], [], [e "are"], [e "ast"], [e "aste"],[])),

  paradigm_h "avm_1p1_rund" ["rund under fötterna"]  $ 
     nocmp $ first_mw "avm" (adj_no_genitive_c 0 ([e ""], [(tk 1,"t")], [], [], [e "are"], [e "ast"], [e "aste"],[])),
  
  paradigm_h "avm_1p1_akut" ["fäst vid"]  $ 
   nocmp $ first_mw "avm" (adj_no_genitive_c 0 ([e ""], [e ""], [], [], [e "are"], [e "ast"], [e "aste"],[])),


  paradigm_h "avm_1x0_akut" ["politiskt korrekt"]  $ 
   nocmp $ last_mw "avm" (adj 0 ([e ""], [e ""], [e "e"], [e "e"], [], [], [])),
...
-- nn6_program,
  ...
  -- vbm_paradigm "vbm_4mnd1_stå" ["stå sitt kast"],    
  ...
  -- vbm_paradigm "vbm_4ad1_dra" ["dra i långbänk"],       
  ...
  -- vbm_paradigm "vbm_1mnd1_laga" ["förtjäna sitt uppehälle"],  
  ...
  vbm_paradigm "vbm_2ad1_sätta" ["sätta på spel"], -- [(ffst (vc "a" . tk 1), "")],
