...
parole_param (pos,p,inhs) = 
 case pos of
   ...
   "ab" -> case p of
             ...
             _ -> error $ "ab " ++ p
   "av" -> case p of
             "pos indef sg f nom"     -> "AQPUSNIS"
             "pos indef sg f gen"     -> "AQPUSGIS"
             "pos indef sg m nom"     -> "AQPUSNIS"
             "pos indef sg m gen"     -> "AQPUSGIS"
   ...
   "vb" -> case unwords [p1 | p1 <- words p, not (elem p1 ["sg","pl","p1","p2","p3"])] of
             ...
             "pret_part indef m nom"         -> "AF0USNIS"
             "pret_part indef f nom"         -> "AF0USNIS"
             "pret_part indef f gen"         -> "AF0USGIS"
             "pret_part indef n nom"         -> "AF0NSNIS"
             "pret_part indef n gen"         -> "AF0NSGIS"
             "pret_part indef nom"         -> "AF00PN0S"
             "pret_part indef gen"         -> "AF00PG0S"

             "pret_part def no_masc nom"  -> "AF00SNDS"
             "pret_part def no_masc gen"  -> "AF00SGDS"
             "pret_part def masc nom"     -> "AF0MSNDS"
             "pret_part def masc gen"     -> "AF0MSGDS"
             "pret_part def nom"          -> "AF00PN0S"
             "pret_part def gen"          -> "AF00PG0S"
             "c"                             -> "V@000C"
             "sms"                           -> "V@000C"             
   ...
   "ppa" -> "SPC"
   "vba" -> "V@000A"
   "vbm" -> (++ "M") $ init $ parole_param ("vb", unwords (filter (\(c:_) -> not (isDigit c)) (words p)),inhs)
   "avm" -> (++ "M") $ init $ parole_param ("av",p,inhs)
   "abm" -> (++ "M") $ init $ parole_param ("ab",p,inhs)
   "inm" -> (++ "M") $ init $ parole_param ("in",p,inhs)
   "nlm" -> (++ "M") $ init $ parole_param ("nl",p,inhs)
   "nnm" -> (++ "M") $ init $ parole_param ("nn",p,inhs)
   "pmm" -> (++ "M") $ init $ parole_param ("pm",p,inhs)
   "pnm" -> (++ "M") $ init $ parole_param ("pn",p,inhs)
   "ppm" -> (++ "M") $ init $ parole_param ("pp",p,inhs)
